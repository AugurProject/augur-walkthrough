...
3. For convenience the script below is provided in augur UI repo. Located at `scripts/pop-candlesticks.sh`. It will populate candlestick chart with fake data. [augur](https://github.com/AugurProject/augur) (Be sure to pass in the market ID create in step 2)
